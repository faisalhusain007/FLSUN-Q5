...
#define STRING_CONFIG_H_AUTHOR "Etsuko Husain Q5 TMS serial " // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 3 //changed from -1
...
#define SERIAL_PORT_2 1 //changed from 3
